...
export const metadata = { title: "Privacy Policy | Uttarakhand Tour Packages" };

export default function PrivacyPolicy() {
  return (
    <LegalShell title="Privacy Policy" subtitle="Uttarakhand Tour Packages — A Holiday Chaska Company">
