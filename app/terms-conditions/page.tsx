...
export const metadata = { title: "Terms & Conditions | Uttarakhand Tour Packages" };

export default function Terms() {
  return (
    <LegalShell title="Terms & Conditions" subtitle="Uttarakhand Tour Packages — A Holiday Chaska Company">
      <ul>
        ...
        <li>Uttarakhand Tour Packages reserves the right to modify itineraries due to weather, road conditions, government restrictions, or force majeure events.</li>
        <li>Tour packages are operated by Holiday Chaska and its authorized partners.</li>
        <li>Governing law: Haldwani, Uttarakhand, India.</li>
